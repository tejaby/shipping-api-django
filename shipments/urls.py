...
from shipments.api.api import CreateShipmentView, UpdateShipmentView, ShippingCostView, OrderStatusView, ShipmentListView
...
urlpatterns = [
    ...
    path('listar', ShipmentListView.as_view(), name='shipment-list'),
]
